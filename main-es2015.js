...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- 해당 제품의 가격이 40000 이상이면 버튼이 보여짐 -->\n<p *ngIf=\"product.price > 40000\">\n  <button (click)=\"notify.emit()\">알림</button>\n</p>");
...
/* harmony import */ var _product_details_product_details_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./product-details/product-details.component */ "./src/app/product-details/product-details.component.ts");
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot([
                ...
                { path: 'products/:productId', component: _product_details_product_details_component__WEBPACK_IMPORTED_MODULE_11__["ProductDetailsComponent"] },
                { path: 'cart', component: _cart_cart_component__WEBPACK_IMPORTED_MODULE_13__["CartComponent"] },
                { path: 'shipping', component: _shipping_shipping_component__WEBPACK_IMPORTED_MODULE_14__["ShippingComponent"] }
            ])
        ],
        providers: [],
        //최초구동시킬컴포넌트
...
let CartComponent = class CartComponent {
    constructor(cartService, formBuilder) {
        ...
        // 주문하기 폼에 저장할 값은 이름과 주소이며 각 name, address가 값으로 분류해서 저장한다.
...
module.exports = __webpack_require__(/*! E:\최수진\1213\05.angular\store\src\main.ts */"./src/main.ts");
